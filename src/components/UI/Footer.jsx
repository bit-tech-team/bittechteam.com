...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 p-5">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              <a
                href="https://bittechteam.com/"
                className="mb-6 inline-block max-w-[160px]"
              >
                <img src={Logo} alt="logo" className="w-20 h-20" />
              </a>
              <p className="text-body-color mb-7 text-base">
                Bit Tech Team is an open source organization that offers
                innovative features and a variety of applications at your
                disposal.
              </p>
