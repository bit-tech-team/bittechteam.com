...
function TermsConditions() {
  return (
    <div className="max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto">
      ...
      <p className="my-2 text-black-500">Welcome to bittechteam.com!</p>

      <p className="my-2 text-black-500">
        These terms and conditions outline the rules and regulations for the use
        of bittechteam's Website, located at https://bittechteam.com/.
      </p>

      <p className="my-2 text-black-500">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use bittechteam.com if you do not agree
      ...
      <p className="my-2 text-black-500">
        We employ the use of cookies. By accessing bittechteam.com, you agreed
        to use cookies in agreement with the bittechteam's Privacy Policy.{" "}
      </p>
      ...
      <p className="my-2 text-black-500">
        Unless otherwise stated, bittechteam and/or its licensors own the
        intellectual property rights for all material on bittechteam.com. All
        intellectual property rights are reserved. You may access this from
        bittechteam.com for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p className="my-2 text-black-500">You must not:</p>
      
      <ul className="!list-disc my-2 text-black-500">
        <li>Republish material from bittechteam.com</li>
        <li>Sell, rent or sub-license material from bittechteam.com</li>
        <li>Reproduce, duplicate or copy material from bittechteam.com</li>
        <li>Redistribute content from bittechteam.com</li>
      </ul>

      <p className="my-2 text-black-500">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        bittechteam does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of bittechteam,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, bittechteam shall not be
      ...
      <p className="my-2 text-black-500">
        bittechteam reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className="my-2 text-black-500">You warrant and represent that:</p>

      <ul className="my-2 text-black-500">
        <li>
      ...
      <p className="my-2 text-black-500">
        You hereby grant bittechteam a non-exclusive license to use, reproduce,
      ...
      <p className="my-2 text-black-500">
        ...
        the hyperlink compensates the absence of bittechteam; and (d) the link
      ...
      <p className="my-2 text-black-500">
        ...
        e-mail to bittechteam. Please include your name, your organization name,
      ...
      <p className="my-2 text-black-500">Approved organizations may hyperlink to our Website as follows:</p>
      ...
      <p className="my-2 text-black-500">
        No use of bittechteam's logo or other artwork will be allowed for
      ...
      <p className="my-2 text-black-500">Please read Privacy Policy</p>
